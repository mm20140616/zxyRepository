...
public class OmOrderLines extends BaseDTO {
    ...
    @Children
    @Transient
    private List<InvInventoryItems> invInventoryItemsList; //物料
    ...
    @Transient
    private Long lineAmountMoney; //总价
    ...
    public Long getLineAmountMoney() {
        return lineAmountMoney;
    }

    public void setLineAmountMoney(Long lineAmountMoney) {
        this.lineAmountMoney = lineAmountMoney;
    }
}
