 ...
 * generated in the com.hand.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorld_QNAME = new QName("http://hand.com/", "getHelloWorld");
    private final static QName _GetHelloWorldResponse_QNAME = new QName("http://hand.com/", "getHelloWorldResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hand.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hand.com/", name = "getHelloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://hand.com/", name = "getHelloWorldResponse")
